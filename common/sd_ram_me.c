...
static void SDRAM_Initialization_Sequence(SDRAM_HandleTypeDef *hsdramt, FMC_SDRAM_CommandTypeDef *Command)
{
  ...
  /* Send the command */
  HAL_SDRAM_SendCommand(hsdramt, Command, 0x1000);
  ...
  HAL_SDRAM_ProgramRefreshRate(hsdramt, REFRESH_COUNT); 
}
